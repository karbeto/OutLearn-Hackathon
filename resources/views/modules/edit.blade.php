...
<div class="p-6 flex justify-center items-center min-h-screen">
    <div class="bg-white shadow-md rounded-lg p-6 w-full max-w-lg">
        <h1 class="text-2xl font-bold text-blue-900 mb-4 text-center">Edit Module</h1>
        ...
        <form action="{{ route('modules.update', $module) }}" method="POST">
            ...
            <div class="flex justify-between items-center">
                <a href="{{ route('modules.index', $module->course) }}" class="text-gray-600 hover:text-gray-800 text-sm">Cancel</a>
